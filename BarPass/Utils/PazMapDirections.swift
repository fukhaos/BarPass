...
//  MeuProtetor
//
//  Created by Bruno Lopes de Mello on 11/04/19.
...
public enum PazNavigationApp {
    ...
    public func directionsUrlString(coordinate: CLLocationCoordinate2D,
        ...
        case .Waze:
            urlString.append("ul?ll=\(coordinate.latitude),\(coordinate.longitude)&navigate=yes")
        }
